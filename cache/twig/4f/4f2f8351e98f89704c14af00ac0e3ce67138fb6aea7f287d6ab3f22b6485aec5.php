...
class __TwigTemplate_8fff4b1b80b5e1a15ba0de6f00b48d9298ae0fffa367a22190da6a6d99e83522 extends Twig_Template
{
...
<p>dimension2 is a collection of [articles](";
        // line 2
        echo call_user_func_array($this->env->getFunction('base_url')->getCallable(), array(true));
...
<p>dimension2 is a collection of [articles]({{ base_url(true)}}/blog), photographs and data stories.</p>
<p>Read more about the author. </p>
<!--![About](about.jpg \"About\")
<div class=\"uk-flex uk-flex-wrap uk-flex-center uk-flex-between  uk-flex-row\">
