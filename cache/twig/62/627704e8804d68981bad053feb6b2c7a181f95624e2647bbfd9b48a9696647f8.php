...
class __TwigTemplate_0f432c1ffa688c882a43ba34f6b955e3a573e22ef401508faecc1610a139b81c extends Twig_Template
{
...
<div class=\"uk-flex uk-flex-wrap uk-flex-center uk-flex-between  uk-flex-row\">
   <a class=\"uk-width-1-3@s uk-card uk-card-secondary uk-card-body uk-margin-top uk-margin-bottom\" href=\"";
        // line 4
...
<p><img title=\"About\" alt=\"About\" src=\"/d2/user/pages/01.home/about.jpg\" /></p>
<div class=\"uk-flex uk-flex-wrap uk-flex-center uk-flex-between  uk-flex-row\">
   <a class=\"uk-width-1-3@s uk-card uk-card-secondary uk-card-body uk-margin-top uk-margin-bottom\" href=\"{{ base_url ~ \"/blog\" }}\">Blog</a>
   <a class=\"uk-width-1-3@s uk-card uk-card-default uk-card-body uk-margin-top uk-margin-bottom\" href=\"{{ base_url ~ \"/photography\" }}\">photography</a>
   <a class=\"uk-width-1-3@s uk-card uk-card-default uk-card-body uk-margin-top uk-margin-bottom\" href=\"{{ base_url ~ \"/datastories\" }}\">Data Stories</a>
