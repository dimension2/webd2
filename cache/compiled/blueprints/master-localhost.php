...
return [
    ...
    'timestamp' => 1518921173,
    'checksum' => '54dea6af93ecf0bca42de0f8116269bc',
    'files' => [
        ...
        'user/plugins' => [
            ...
            'plugins/thumb-ratings' => [
                'file' => 'user/plugins/thumb-ratings/blueprints.yaml',
                'modified' => 1518921100
            ]
        ]
    ],
    'data' => [
        'items' => [
            ...
            'plugins.shortcodes.global' => [
                'type' => 'section',
                'underline' => 1,
                'name' => 'plugins.shortcodes.global',
                'validation' => 'strict'
            ],
            ...
            'plugins.shortcodes.assets.options' => [
                'type' => 'fieldset',
                'collapsible' => true,
                'collapsed' => true,
                'icon' => 'gear',
                'name' => 'plugins.shortcodes.assets.options',
                'validation' => 'strict'
            ],
            'plugins.shortcodes.assets' => [
                'type' => 'fieldset',
                'collapsible' => false,
                'icon' => 'list-alt',
                'name' => 'plugins.shortcodes.assets',
                'validation' => 'strict'
            ],
            ...
            'plugins.shortcodes.comment' => [
                'type' => 'fieldset',
                'collapsed' => true,
                'icon' => 'comments',
                'name' => 'plugins.shortcodes.comment',
                'validation' => 'strict'
            ],
            ...
            'plugins.shortcodes.embed.options' => [
                'type' => 'fieldset',
                'collapsible' => true,
                'collapsed' => true,
                'icon' => 'gear',
                'name' => 'plugins.shortcodes.embed.options',
                'validation' => 'strict'
            ],
            'plugins.shortcodes.embed' => [
                'type' => 'fieldset',
                'collapsible' => true,
                'collapsed' => false,
                'icon' => 'trello',
                'name' => 'plugins.shortcodes.embed',
                'validation' => 'strict'
            ],
            ...
            'plugins.shortcodes.markdown.options' => [
                'type' => 'fieldset',
                'collapsible' => true,
                'collapsed' => true,
                'icon' => 'gear',
                'name' => 'plugins.shortcodes.markdown.options',
                'validation' => 'strict'
            ],
            'plugins.shortcodes.markdown' => [
                'type' => 'fieldset',
                'collapsible' => false,
                'icon' => 'code',
                'name' => 'plugins.shortcodes.markdown',
                'validation' => 'strict'
            ],
            ...
            'plugins.shortcodes.summary' => [
                'type' => 'fieldset',
                'collapsible' => false,
                'icon' => 'align-justify',
                'name' => 'plugins.shortcodes.summary',
                'validation' => 'strict'
            ],
            ...
            'plugins.shortcodes.twig' => [
                'type' => 'fieldset',
                'collapsible' => false,
                'icon' => 'leaf',
                'name' => 'plugins.shortcodes.twig',
                'validation' => 'strict'
            ],
            'plugins.shortcodes.default' => [
                'type' => 'section',
                'underline' => 1,
                'name' => 'plugins.shortcodes.default',
                'validation' => 'strict'
            ],
            'plugins.simplesearch' => [
                'form' => [
            ...
            'plugins.thumb-ratings.enabled' => [
                ...
                'name' => 'plugins.thumb-ratings.enabled',
                'validation' => 'strict'
            ],
            'plugins.thumb-ratings.built_in_css' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.thumb-ratings.built_in_css',
                'validation' => 'strict'
            ],
            'plugins.thumb-ratings.callback' => [
                'type' => 'text',
                'size' => 'medium',
                'label' => 'THUMBRATINGS_PLUGIN.CALLBACK_URL',
                'name' => 'plugins.thumb-ratings.callback',
                'validation' => 'strict'
            ],
            'plugins.thumb-ratings.unique_ip_check' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.thumb-ratings.unique_ip_check',
                'validation' => 'strict'
            ],
            'plugins.thumb-ratings.readonly' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.thumb-ratings.readonly',
                'validation' => 'strict'
            ],
            'plugins.thumb-ratings.disable_after_vote' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.thumb-ratings.disable_after_vote',
                'validation' => 'strict'
            ],
            'plugins.thumb-ratings.up_bgcolor' => [
                'type' => 'colorpicker',
                'size' => 'medium',
                'label' => 'THUMBRATINGS_PLUGIN.UP_BGCOLOR',
                'name' => 'plugins.thumb-ratings.up_bgcolor',
                'validation' => 'strict'
            ],
            'plugins.thumb-ratings.down_bgcolor' => [
                'type' => 'colorpicker',
                'size' => 'medium',
                'label' => 'THUMBRATINGS_PLUGIN.DOWN_BGCOLOR',
                'name' => 'plugins.thumb-ratings.down_bgcolor',
                'validation' => 'strict'
            ],
            'plugins.thumb-ratings.up_color' => [
                'type' => 'colorpicker',
                'size' => 'medium',
                'label' => 'THUMBRATINGS_PLUGIN.UP_COLOR',
                'name' => 'plugins.thumb-ratings.up_color',
                'validation' => 'strict'
            ],
            'plugins.thumb-ratings.down_color' => [
                'type' => 'colorpicker',
                'size' => 'medium',
                'label' => 'THUMBRATINGS_PLUGIN.DOWN_COLOR',
                'name' => 'plugins.thumb-ratings.down_color',
                'validation' => 'strict'
            ]
        ],
        'rules' => [
        ...
        'nested' => [
            ...
            'plugins' => [
                ...
                'shortcodes' => [
                    'global' => 'plugins.shortcodes.global',
                    'enabled' => 'plugins.shortcodes.enabled',
                    'default' => 'plugins.shortcodes.default',
                    'assets' => [
                        'options' => 'plugins.shortcodes.assets.options'
                    ],
                    'shortcodes' => [
                        'assets' => [
                    ...
                    'comment' => 'plugins.shortcodes.comment',
                    'embed' => [
                        'options' => 'plugins.shortcodes.embed.options'
                    ],
                    'markdown' => [
                        'options' => 'plugins.shortcodes.markdown.options'
                    ],
                    'summary' => 'plugins.shortcodes.summary',
                    'twig' => 'plugins.shortcodes.twig'
                ],
                'simplesearch' => [
                ...
                'thumb-ratings' => [
                    'enabled' => 'plugins.thumb-ratings.enabled',
                    'built_in_css' => 'plugins.thumb-ratings.built_in_css',
                    'callback' => 'plugins.thumb-ratings.callback',
                    'unique_ip_check' => 'plugins.thumb-ratings.unique_ip_check',
                    'readonly' => 'plugins.thumb-ratings.readonly',
                    'disable_after_vote' => 'plugins.thumb-ratings.disable_after_vote',
                    'up_bgcolor' => 'plugins.thumb-ratings.up_bgcolor',
                    'down_bgcolor' => 'plugins.thumb-ratings.down_bgcolor',
                    'up_color' => 'plugins.thumb-ratings.up_color',
                    'down_color' => 'plugins.thumb-ratings.down_color'
                ]
            ]
        ],
        'dynamic' => [
